...
/// <summary>
/// List-taking variants of the FAKE target operators. These are unused by the
/// ActionPath-driven commands in Program.fs, and are kept here for the case
/// where a target ever grows a real dependency graph.
/// </summary>
[<AutoOpen>]
